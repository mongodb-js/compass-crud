...
//             expect(actions.addColumn.alwaysCalledWithExactly('field1', 2, [])).to.equal(true);
...
//         it('calls addColumn action', () => {
//           expect(actions.addColumn.callCount).to.equal(1);
//           expect(actions.addColumn.alwaysCalledWithExactly('field1', 2, ['field1'])).to.equal(true);
//           notCalledExcept(actions, ['addColumn']);
//         });
...
//           it('calls addColumn action', () => {
//             expect(actions.addColumn.callCount).to.equal(1);
//             expect(actions.addColumn.alwaysCalledWithExactly(1, 2, ['field0'])).to.equal(true);
//             notCalledExcept(actions, ['addColumn']);
//           });
//           it('adds the new element to the sub element', () => {
//             // expect(value.nextElement.currentKey).to.equal('$new');
